...
namespace WinForm {
    ...
    public partial class orderDataSet : global::System.Data.DataSet {
        ...
        public partial class ordersDataTable : global::System.Data.TypedTableBase<ordersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ordersRow AddordersRow(string Client, double Total) {
...
namespace WinForm.orderDataSetTableAdapters {
    ...
    public partial class ordersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `orders` WHERE ((`ID` = @p1) AND (`Total` = @p2))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `orders` (`Client`, `Total`) VALUES (@p1, @p2)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `orders` SET `Client` = @p1, `Total` = @p2 WHERE ((`ID` = @p3) AND (`Total" +
                "` = @p4))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WinForm.Properties.Settings.Default.orderConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `ID`, `Client`, `Total` FROM `orders`";
